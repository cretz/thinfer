...
- `plan-details.md` — engine-wide design decisions (the "how" beyond orig-plan). Per-model porting details go in their own file (`zimage-plan.md`, `ltx-plan.md`, etc), not here.
- `worklog.md` — chronological progress, what's next.
