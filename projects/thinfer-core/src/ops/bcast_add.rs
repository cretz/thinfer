...
impl BcastAddOp for BcastAddF32 {
    ...
    fn wgsl(cfg: &WgslConfig) -> &'static str {
        match (cfg.bf16_quant_writes, cfg.weight_dtype) {
            (false, WeightDtype::F32) => WGSL_F32,
            (true, WeightDtype::F32) => WGSL_F32_BF16Q,
            (false, WeightDtype::Bf16) => WGSL_F32_WBF16,
            (true, WeightDtype::Bf16) => WGSL_F32_BF16Q_WBF16,
        }
    }
    fn layout() -> &'static [BindingLayout] {
        LAYOUT
