...
impl Op for MulF32 {
    const KERNEL_ID: &'static str = "mul.f32";
    type Dtype = F32;
    const INPUTS: &'static [&'static str] = &["mul/a", "mul/b"];
    const OUTPUT: &'static str = "mul/out";
...
impl OpTest for MulF32 {
    ...
    fn run_test<'a>(
        ...
        Box::pin(ctx.run_elementwise::<MulF32>())
    }
}
